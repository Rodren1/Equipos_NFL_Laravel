...
<div class="container" style="background-color: darkred;">
    ...
    <div>
        <p>
            <br>
            <h4 style="color: black;"><i>La National Football League (NFL), es la mayor liga de
                    ...
                    enfrentan ambas conferencias integradas por sus mejores jugadores de ese año.</i></h4>
            <br>
        </p>
    </div>
</div>
